...
const debug = require('debug')('OneloveEncoderService:cli:daemon')
...
module.exports = {
    ...
    async handler(argv) {
        ...
        print('Initializing OneloveEncoderService daemon...')
        print(`OneloveEncoderService version: ${require('../../../package.json').version}`)
